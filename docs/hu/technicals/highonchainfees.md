...
* Használj privát \(nem hirdetett\) csatornákat [költő node](../node-types/nodetype.spending.md)-ként, így a leállások nem okoznak kényszerített bezárást a partner részéről
...
* Kötegelelt nyitások
  ...
  * használhatsz PSBT-ket \(akár külső tárcából is\) a rendelkezésre álló parancssori eszközökkel:
    ...
    * [Core Lightning (CLN) CLI](https://lightning.readthedocs.io/lightning-fundchannel_start.7.html#)
...
* Ha [őrtorony](../advanced-tools/watchtower.md)-okat használsz, be kell állítani a
...
* [Bezárható-e egy csatorna, amíg a finanszírozási tranzakció még a mempool-ban várakozik?](https://bitcoin.stackexchange.com/questions/102180/can-a-channel-be-closed-while-the-funding-tx-is-still-stuck-in-the-mempool)
