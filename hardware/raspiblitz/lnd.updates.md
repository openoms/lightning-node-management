...
## [Update LND to v0.16.1-beta](https://github.com/openoms/lightning-node-management/tree/en/lnd.updates/lnd.update.v0.16.1-beta.sh)

* Run in the RaspiBlitz terminal to use:

  ```bash
    # download
    wget https://raw.githubusercontent.com/openoms/lightning-node-management/en/lnd.updates/lnd.update.v0.16.1-beta.sh
    # look through the script
    cat lnd.update.v0.16.1-beta.sh
    # run
    bash lnd.update.v0.16.1-beta.sh
  ```

## [Update LND to v0.16.0-beta](https://github.com/openoms/lightning-node-management/tree/en/lnd.updates/lnd.update.v0.16.0-beta.sh)

* Run in the RaspiBlitz terminal to use:

  ```bash
    # download
    wget https://raw.githubusercontent.com/openoms/lightning-node-management/en/lnd.updates/lnd.update.v0.16.0-beta.sh
    # look through the script
    cat lnd.update.v0.16.0-beta.sh
    # run
    bash lnd.update.v0.16.0-beta.sh
  ```
