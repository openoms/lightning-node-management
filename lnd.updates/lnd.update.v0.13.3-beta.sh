...
# LND Update Script
# Download:
# wget https://raw.githubusercontent.com/openoms/lightning-node-management/master/lnd.updates/lnd.update.v0.13.3.sh
# inspect
# cat lnd.update.v0.13.3.sh
# run
# bash lnd.update.v0.13.3.sh
