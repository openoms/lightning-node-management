...
# LND Update Script
# Download:
# wget https://raw.githubusercontent.com/openoms/lightning-node-management/master/lnd.updates/lnd.update.v0.12.1.sh
# inspect
# cat lnd.update.v0.12.1.sh
# run
# bash lnd.update.v0.12.1.sh
